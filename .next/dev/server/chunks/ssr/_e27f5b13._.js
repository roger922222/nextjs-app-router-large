module.exports = [
"[project]/lib/performance-tests-browser.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";

// Performance Test Suite - Browser Compatible Version
...
function generateTestSummary(reports) {
    ...
    if (totalFailed > 0) {
        recommendations.push(`修复 ${totalFailed} 个失败测试以改善性能`);
    }
    if (totalWarnings > 0) {
        recommendations.push(`检查 ${totalWarnings} 个警告测试以获得潜在改进`);
    }
    if (averageDuration > 1000) {
        recommendations.push('考虑优化测试性能 - 平均持续时间过长');
    }
    return {
        totalTests,
        totalPassed,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$performance$2d$tests$2d$browser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/performance-tests-browser.ts [app-ssr] (ecmascript)");
...
function PerformanceTestDemo() {
    ...
    const runTests = async ()=>{
        ...
        setTestReports([]);
        try {
            const reports = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$performance$2d$tests$2d$browser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["runAllPerformanceTests"])();
            setTestReports(reports);
            setTestSummary((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$performance$2d$tests$2d$browser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateTestSummary"])(reports));
        } catch (error) {
...
//# sourceMappingURL=_e27f5b13._.js.map