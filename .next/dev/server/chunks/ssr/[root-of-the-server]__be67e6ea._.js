...
"[project]/lib/data-compression.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class DataCompressionManager {
   ...
   */ compress(data) {
        return new Promise((resolve, reject)=>{
            ...
            switch(this.config.type){
                case 'gzip':
                    __TURBOPACK__imported__module__$5b$externals$5d2f$zlib__$5b$external$5d$__$28$zlib$2c$__cjs$29$__["default"].gzip(dataBuffer, {
                        level: this.config.level || __TURBOPACK__imported__module__$5b$externals$5d2f$zlib__$5b$external$5d$__$28$zlib$2c$__cjs$29$__["default"].constants.Z_DEFAULT_COMPRESSION
                    }, (err, result)=>{
                        if (err) reject(err);
                        resolve(result);
                    });
                    break;
                case 'deflate':
                    __TURBOPACK__imported__module__$5b$externals$5d2f$zlib__$5b$external$5d$__$28$zlib$2c$__cjs$29$__["default"].deflate(dataBuffer, {
                        level: this.config.level || __TURBOPACK__imported__module__$5b$externals$5d2f$zlib__$5b$external$5d$__$28$zlib$2c$__cjs$29$__["default"].constants.Z_DEFAULT_COMPRESSION
                    }, (err, result)=>{
                        if (err) reject(err);
                        resolve(result);
                    ...
                    break;
                case 'brotli':
                    if ('brotliCompress' in __TURBOPACK__imported__module__$5b$externals$5d2f$zlib__$5b$external$5d$__$28$zlib$2c$__cjs$29$__["default"]) {
                        __TURBOPACK__imported__module__$5b$externals$5d2f$zlib__$5b$external$5d$__$28$zlib$2c$__cjs$29$__["default"].brotliCompress(dataBuffer, {
                        ...
                        __TURBOPACK__imported__module__$5b$externals$5d2f$zlib__$5b$external$5d$__$28$zlib$2c$__cjs$29$__["default"].gzip(dataBuffer, (err, result)=>{
                            if (err) reject(err);
                            resolve(result);
                        });
                    }
   ...
   */ decompress(buffer) {
        return new Promise((resolve, reject)=>{
            ...
            if (magicNumber === '1f8b') {
                // Gzip
                decompressFn = __TURBOPACK__imported__module__$5b$externals$5d2f$zlib__$5b$external$5d$__$28$zlib$2c$__cjs$29$__["default"].gunzip;
            } else if (magicNumber === '789c') {
                // Deflate
                decompressFn = __TURBOPACK__imported__module__$5b$externals$5d2f$zlib__$5b$external$5d$__$28$zlib$2c$__cjs$29$__["default"].inflate;
            } else if ('brotliDecompress' in __TURBOPACK__imported__module__$5b$externals$5d2f$zlib__$5b$external$5d$__$28$zlib$2c$__cjs$29$__["default"] && magicNumber.startsWith('1890')) {
                // Brotli
                decompressFn = __TURBOPACK__imported__module__$5b$externals$5d2f$zlib__$5b$external$5d$__$28$zlib$2c$__cjs$29$__["default"].brotliDecompress;
            } else {
                // 未压缩数据
                try {
...
"[project]/components/DataCompressionDemo.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2d$compression$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/data-compression.ts [app-ssr] (ecmascript)");
...
function DataCompressionDemo() {
    ...
    const [paginationResults, setPaginationResults] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('compression');
    ...
    const testCompression = async ()=>{
        ...
        for (const algorithm of algorithms){
            ...
            try {
                const compressed = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2d$compression$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["compressData"])(jsonString, algorithm);
    ...
    const testBatchRequests = async ()=>{
        ...
        const batchRequest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2d$compression$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createBatchRequest"])(Array.from({
            length: 50
        }, (_, i)=>({
                url: `/api/items/${i}`,
                method: 'GET'
    ...
    const testPagination = async ()=>{
        ...
        for(let page = 1; page <= 5; page++){
            const startTime = performance.now();
            const paginatedData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2d$compression$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createPaginationResponse"])(totalData, page, 20);
            const endTime = performance.now();
            results.push({
                page,
                pageSize: 20,
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        ...
                                        paginationResults.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "space-y-4",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "grid gap-2",
                                                    children: paginationResults.map((result, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__be67e6ea._.js.map