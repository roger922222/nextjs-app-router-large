...
"[project]/lib/image-optimization.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$optimization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/image-optimization.ts [app-client] (ecmascript)");
;
...
function OptimizedImage({ src, alt, width, height, priority = false, quality = 75, className = '', objectFit = 'cover', placeholder = 'blur', blurDataURL, sizes, srcSet, loading = 'lazy' }) {
    ...
    const [webpSupported, setWebpSupported] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    // 检查WebP支持
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OptimizedImage.useEffect": ()=>{
            setWebpSupported((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$optimization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isWebPSupported"])());
        }
    }["OptimizedImage.useEffect"], []);
    // 优先加载图片
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OptimizedImage.useEffect": ()=>{
            if (priority) {
                const optimizedSrc = webpSupported ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$optimization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWebPUrl"])(src) : src;
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$optimization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["preloadImage"])(optimizedSrc).then({
                    "OptimizedImage.useEffect": ()=>{
                        setImageSrc(optimizedSrc);
                        setIsLoading(false);
                    }
                }["OptimizedImage.useEffect"]).catch({
                    "OptimizedImage.useEffect": ()=>{
                        setImageSrc(src);
                        setError(true);
                    }
    ...
    const getPlaceholderBlur = ()=>{
        ...
        if (width && height) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$optimization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateBlurDataURL"])(width, height);
        }
        return undefined;
    };
    // 生成响应式srcset
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            isLoading && placeholder === 'blur' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(OptimizedImage, "AEsVu1dds7FrNJGG24uldtUrSS8=");
_c = OptimizedImage;
function LazyImage(props) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(OptimizedImage, {
        ...props,
        loading: "lazy"
    }, void 0, false, {
        fileName: "[project]/components/OptimizedImage.tsx",
...
__turbopack_context__.k.register(_c2, "PriorityImage");
__turbopack_context__.k.register(_c3, "ResponsiveImage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/ImageOptimizationDemo.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ImageOptimizationDemo() {
    ...
    const [compressionResult, setCompressionResult] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // 示例图片数据
    const demoImages = [
        {
            id: 1,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ImageOptimizationDemo.useEffect": ()=>{
            setWebPSupported((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$optimization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isWebPSupported"])());
        }
    }["ImageOptimizationDemo.useEffect"], []);
    // 模拟图片压缩
    const handleCompressImage = async (imageUrl)=>{
        try {
            ...
            // 压缩图片
            const compressedBlob = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$optimization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["compressImage"])(blob, {
                quality: 75,
                maxWidth: 800,
                maxHeight: 600,
                format: 'webp'
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$OptimizedImage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResponsiveImage"], {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: Array.from({
                            length: 10
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$OptimizedImage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LazyImage"], {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: demoImages.map((image)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    compressionResult && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$optimization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatFileSize"])(compressionResult.originalSize)
                                            }, void 0, false, {
                                                fileName: "[project]/components/ImageOptimizationDemo.tsx",
                                                lineNumber: 190,
                                                columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "stat-value",
                                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$optimization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatFileSize"])(compressionResult.compressedSize)
                                            }, void 0, false, {
                                                fileName: "[project]/components/ImageOptimizationDemo.tsx",
                                                lineNumber: 194,
                                                columnNumber: 17
...
_s(ImageOptimizationDemo, "u+bkhCbn9n5KZLDtLEA4TW8y0Uo=");
_c = ImageOptimizationDemo;
var _c;
__turbopack_context__.k.register(_c, "ImageOptimizationDemo");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_67c3d6cd._.js.map